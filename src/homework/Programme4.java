...
public class Programme4 {
    ...
    public static int getDaysInMonth(int month, int year1) {
        ...
        if (year1 < 1 || year1 > 9999 ){
            System.out.println(daysInMonth + " Since the parameter year is outside the range of 1 to 9999");
            return daysInMonth;
            ...
            switch (month) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Month is March with 31 day and ");
                    isLeapYear(year1);
                    break;
                case 4:
                    System.out.println("Month is April with 30 day and ");
                    isLeapYear(year1);
                    break;
                case 5:
                    System.out.println("Month is May with 31 day and ");
                    isLeapYear(year1);
                    break;
                case 6:
                    System.out.println("Month is June with 30 day and ");
                    isLeapYear(year1);
                    break;
                case 7:
                    System.out.println("Month is July with 31 day and ");
                    isLeapYear(year1);
                    break;
                case 8:
                    System.out.println("Month is August with 31 day and ");
                    isLeapYear(year1);
                    break;
                case 9:
                    System.out.println("Month is September with 30 day and ");
                    isLeapYear(year1);
                    break;
                case 10:
                    System.out.println("Month is October with 31 day and ");
                    isLeapYear(year1);
                    break;
                case 11:
                    System.out.println("Month is November with 30 day and ");
                    isLeapYear(year1);
                    break;
                case 12:
                    System.out.println("Month is December with 31 day and ");
                    isLeapYear(year1);
                    break;
            }
        }
